// Solicitudes de acceso (solo Broker): aprueba o rechaza cuentas nuevas.
// Al registrarse, cada cuenta queda "Pendiente" con el rol que la persona
// solicitó; el broker puede corregir el rol antes de aprobar.
...
// El broker no puede otorgar el rol broker desde aquí (evita escalamiento por descuido).
...
export default function SolicitudesAcceso({ usuarios, onResolver }: Props) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-6 sm:px-6">
      <h1 className="text-xl font-bold text-slate-900">Solicitudes de acceso</h1>
      <p className="mt-1 text-sm text-slate-500">
        Personas que crearon cuenta y esperan tu aprobación. Verifica el rol antes de aprobar:
        define qué información podrán ver.
      </p>
